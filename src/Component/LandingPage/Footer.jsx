            ...
            <section class="py-10 bg-white sm:py-16 lg:py-24">
                <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div class="text-center">
                        <h4 class="text-xl font-medium text-gray-900">Numbers tell the hard works we’ve done in last 20 years</h4>
                    </div>
                        ...
                        <div class="overflow-hidden bg-white border border-gray-200 rounded-lg">
                            <div class="px-4 py-6">
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-4">
                                        <h4 class="text-4xl font-bold text-gray-900">24+</h4>
                        ...
                        <div class="overflow-hidden bg-white border border-gray-200 rounded-lg">
                            <div class="px-4 py-6">
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-4">
                                        <h4 class="text-4xl font-bold text-gray-900">3700+</h4>
                        ...
                        <div class="overflow-hidden bg-white border border-gray-200 rounded-lg">
                            <div class="px-4 py-6">
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-4">
                                        <h4 class="text-4xl font-bold text-gray-900">1.1M</h4>
                                        <p class="mt-1.5 text-lg font-medium leading-tight text-gray-500">Packages delivered</p>
                                    </div>
                                </div>
                            </div>
                        </div>
